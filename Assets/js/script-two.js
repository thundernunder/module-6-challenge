...
function getWeather() {
  ...
  .then(function(data) {
    ...
    var fiveDayQuery = "api.openweathermap.org/data/2.5/forecast?q=" + cityName + "&units=imperial&appid=" + apiKEY;
  ...
  var cityLat = data.city.coord.lat;
      ...
      var uvURl = "api.openweathermap.org/data/2.5/uvi?lat=" + cityLat + "&lon=" + cityLon + "&appid=" + apiKEY;
...
$('#search-buttons').on('click', '.dynamicButton',function(){
  ...
  .then(function(data) {
    ...
    var cityLat = data.city.coord.lat;
      var cityLon = data.city.coord.lon;
      var uvURl = "https://api.openweathermap.org/data/2.5/uvi?lat=" + cityLat + "&lon=" + cityLon + "&appid=" + apiKEY;
