...
var weatherApiKey = 'f4ac895478946fb295776c00914a0c9e'
var buttonEl = $('button');
...
function fetchWeather(location) {
  ...
  var apiUrl = `${weatherRootUrl}/data/2.5/onecall?lat=${lat}&lon=${lon}&units=imperial&exclude=minutely,hourly&appid=${weatherApiKey}`;
...
function fetchCoords(search) {
  var apiUrl = `${weatherRootUrl}/geo/1.0/direct?q=${search}&limit=5&appid=${weatherApiKey}`;
